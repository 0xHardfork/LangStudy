...
type LLMConfig struct {
	...
	SubtitleTranslatePromptTpl string    `gorm:"column:subtitle_translate_prompt_tpl;not null" json:"subtitle_translate_prompt_tpl"`
	SubtitleAnalyzePromptTpl   string    `gorm:"column:subtitle_analyze_prompt_tpl;not null" json:"subtitle_analyze_prompt_tpl"`
...
type UpdateConfigRequest struct {
	...
	SubtitleTranslatePromptTpl string `json:"subtitle_translate_prompt_tpl"`
	SubtitleAnalyzePromptTpl   string `json:"subtitle_analyze_prompt_tpl"`
}
