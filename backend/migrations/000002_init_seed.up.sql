...
VALUES (1, 'https://api.openai.com/v1', 'sk-placeholder', 'gpt-4o', 
    'Generate a natural dialogue in {{language}} at {{level}} level about the topic "{{topic}}".{{topic_description}}
...
[{"line_index":0,"word":"<word>","word_index":0,"importance":1},...]',
    'You are an expert English grammar teacher. Analyze the grammar structure of the following sentence and generate a Cloze multiple-choice question testing a key grammar point.
