      ...
      <div className="min-h-screen bg-slate-950 text-slate-50 flex flex-col">
          ...
          <div className="mx-auto max-w-5xl px-4 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="rounded-lg bg-slate-900 border border-slate-800 px-3.5 py-1.5 text-xs font-semibold text-slate-300 hover:text-white hover:border-slate-700 transition-colors cursor-pointer mr-1"
              >
                Change Password
              </button>
              <button
        ...
        >
          ...
          >
            ...
            <Form.Item className="mb-0 flex justify-end space-x-2">
              <Button onClick={() => setChangePwdModalOpen(false)} className="mr-2 cursor-pointer" disabled={changePwdSubmitting}>
                Cancel
              </Button>
              <Button type="primary" htmlType="submit" className="bg-purple-600 border-none cursor-pointer" loading={changePwdSubmitting}>
                Change Password
              </Button>
            </Form.Item>
          </Form>
